const questions = [
    {
        questions: "What is largets animal in the world?",
        answers: [
    ...
    {
        questions: "What is smallest country in the world?",
        answers: [
    ...
    {
        questions: "What is largets desert in the world?",
        answers: [
...
function showQuestion(){
    ...
    questionElement.innerHTML = questionNo + ". " + currentQustion.questions;
